...
export function SidebarNavigation({
  ...
  /** Optional map of path -> count for showing unread badges (e.g. notifications) */
                    ...
                    <ContentContainer>
                      {item.children.map((child, childIndex) => {
                        ...
                        const TriggerItem = () => {
                          ...
                          const badgeCount = path ? badgeByPath?.[path] ?? 0 : 0;
                                ...
                                {badgeCount > 0 && (
                                  <span
                                    className={cn(
                                      ...
                                      !open && 'absolute right-1 top-1/2 -translate-y-1/2',
                                    )}
